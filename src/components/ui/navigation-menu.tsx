...
>(({ className, children, ...props }, ref) => (
    <NavigationMenuPrimitive.Root
        ref={ref}
        className={cn(
            "relative z-10 flex w-full flex-1 flex-row items-center justify-center",
            className
        )}
        {...props}
    >
...
>(({ className, ...props }, ref) => (
    <NavigationMenuPrimitive.List
        ref={ref}
        className={cn(
            "group flex flex-1 list-none items-center justify-between space-x-1 w-[calc(100vw-150px)]",
            className
        )}
        {...props}
    />
